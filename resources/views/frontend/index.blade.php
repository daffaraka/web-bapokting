                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('frontpage/assets/img/blog/blog-1.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('frontpage/assets/img/blog/blog-2.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('frontpage/assets/img/blog/blog-author-2.jpg') }}" alt=""
                                    class="img-fluid post-author-img flex-shrink-0">
                                <div class="post-meta">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('frontpage/assets/img/blog/blog-3.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('frontpage/assets/img/blog/blog-author-3.jpg') }}" alt=""
                                    class="img-fluid post-author-img flex-shrink-0">
                                <div class="post-meta">
